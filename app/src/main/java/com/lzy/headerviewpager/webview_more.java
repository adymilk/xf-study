...
public class webview_more extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //设置沉浸的颜色
        tintManager.setStatusBarTintResource(R.color.xfhlp);
        init("http://xfhelp.top");
    ...
    public  void init(String url){
        webView = (WebView) findViewById(R.id.webView_more);
        //支持javascript
